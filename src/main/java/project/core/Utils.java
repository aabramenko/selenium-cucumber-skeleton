...
public class Utils {
    ...
    public static String removePackageNameFromPath(String str) {
        str = str.replace("project.project.steps.", "");
        str = str.replace("project.pages.example.", "");
        str = str.replace("project.cases.", "");
        return str;
    }

    public static Screenshot getScreenshot(WebDriver driver) {
    ...
    public static byte[] convertScreenshotToByte(Screenshot screenshot) {
